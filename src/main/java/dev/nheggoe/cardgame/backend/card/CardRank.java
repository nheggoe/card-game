...
/**
 * Represents the rank of a playing card in a standard deck. A card rank can have values ranging
 * from Ace ("1") to King ("K"). Each rank is associated with a specific symbol that represents it.
 *
 * @author Nick Heggø
 * @version 2025.03.03
 */
