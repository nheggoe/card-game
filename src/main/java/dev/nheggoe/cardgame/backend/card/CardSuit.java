...
public enum CardSuit {
  ...
  /**
   * Retrieves the character representing the suit of the card. The suit character corresponds to
   * the abbreviations of the card suits, such as 'H' for Hearts, 'D' for Diamonds, 'C' for Clubs,
   * and 'S' for Spades.
   *
