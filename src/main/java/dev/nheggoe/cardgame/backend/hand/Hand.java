 ...
 * Provides functionality to add cards individually or as a collection
 * and determine specific properties of the hand, such as whether it forms a flush.
 *
 * @author Nick Heggø
 * @version 2025.03.03
 */
public class Hand {
    ...
    /**
     * Determines if the hand is a flush, which means five cards in the hand
